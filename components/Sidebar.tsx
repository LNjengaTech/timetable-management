                    ...
                    <div className={clsx("flex items-center gap-3", isCollapsed && "justify-center")}>
                        ...
                        {!isCollapsed && (
                            <div className="truncate">
                                <p className="text-sm font-medium text-gray-900 dark:text-white truncate">{session?.user?.name || "Guest User"}</p>
                                {role && <p className="text-xs text-brand-600 dark:text-brand-400 font-semibold">{role}</p>}
                                {!role && <p className="text-xs text-gray-500">Viewing Preview</p>}
                            </div>
                        )}
                    </div>
