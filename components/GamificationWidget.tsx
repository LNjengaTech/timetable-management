...
export default async function GamificationWidget() {
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-2xl border border-gray-700 shadow-xl relative overflow-hidden group hover:border-brand-500/50 transition-all">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-gray-900/80 p-4 rounded-xl border border-gray-700/50 flex flex-col items-center justify-center text-center">
            ...
            <span className="text-xs text-gray-400 font-medium uppercase tracking-wider mt-1">Day Streak</span>
          </div>
          
          <div className="bg-gray-900/80 p-4 rounded-xl border border-gray-700/50 flex flex-col items-center justify-center text-center">
            <Star className="w-8 h-8 text-yellow-400 mb-2" />
            <span className="text-2xl font-black text-white">{points}</span>
            <span className="text-xs text-gray-400 font-medium uppercase tracking-wider mt-1">Total Points</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="w-full bg-gray-900 rounded-full h-2.5 border border-gray-700 overflow-hidden">
            <div 
              className="bg-gradient-to-r from-brand-600 to-brand-400 h-2.5 rounded-full transition-all duration-1000 ease-out" 
