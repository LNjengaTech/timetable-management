...
export default function StatsGrid({ streak, points, attendanceRate, totalClasses }: StatsGridProps) {
    ...
    return (
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat) => (
                <div key={stat.label} className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all group">
                    ...
                    <div className="flex items-end gap-2">
                        <span className="sm:text-3xl font-bold dark:text-white">{stat.value}</span>
