...
import {
  UploadCloud, FileType2, Image as ImageIcon, FileSpreadsheet,
  Loader2, CheckCircle2, AlertCircle, Pencil, Trash2, Plus
} from "lucide-react"
    ...
    <div className="max-w-5xl mx-auto p-8">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        {[
          ...
          { label: "Spreadsheet", sub: ".xlsx / .csv", Icon: FileSpreadsheet, color: "green" },
        ].map(({ label, sub, Icon, color }) => (
          <div key={label} className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl flex items-center gap-4">
        ...
        <div className="mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="mt-4 flex justify-between items-center">
            ...
            <div className="flex gap-3">
              ...
              >
                Save {slots.length} slot{slots.length !== 1 ? "s" : ""} to My Schedule
              </button>
            </div>
          </div>
        </div>
      ...
      {status === "done" && (
        <div className="mt-10 flex flex-col items-center gap-3">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white">
            {savedCount} slot{savedCount !== 1 ? "s" : ""} saved!
          </p>
